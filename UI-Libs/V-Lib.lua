...
function VLib:Window(title)
 ...
 LeftFrame.BorderSizePixel = 2
	...
	function Tabs:Tab(text)
		...
		Tab.BackgroundColor3 = Color3.fromRGB(32, 33, 37)
...
Tab.BorderColor3 = Color3.fromRGB(0,255,255)
Tab.BorderSizePixel = 2
		...
		function ContainerItems:Toggle(text, callback)
			...
			ToggleFrameRainbow.BackgroundColor3 = Color3.fromRGB(0,255,255)
		...
		function ContainerItems:Slider(text, min, max, start, callback) 
			...
			SliderIndicator.BackgroundColor3 = Color3.fromRGB(0,255,255)
		...
		function ContainerItems:Colorpicker(text, preset, callback)
			...
			RainbowToggleFrame.BackgroundColor3 = Color3.fromRGB(32, 33, 37)
			...
			RainbowToggleFrameRainbow.BackgroundColor3 = Color3.fromRGB(0,255,255)
